...
$pdf->ezText("<b>Consulta 3 - Cantidad de puestos por departamento</b>",25,array("justification"=>"center")); // Titulo 2
...
$cols = array(
    ...
    "Cantidad de Puestos" => "<b>Cantidad de Puestos</b>",
 );

$colOptions = array(
	"Departamento" => array('justification' => 'left', 'width' => 160),			 
	"Cantidad de Puestos" => array('justification'=> 'centre',  'width' => 70),		
			 );
